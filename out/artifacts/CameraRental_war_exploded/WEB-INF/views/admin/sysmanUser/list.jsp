...
<table id="dg-1" class="easyui-datagrid" title="列表" style="width: 700px; height: 300px"
    ...
    <tr>
        ...
        <th data-options="field:'locked',width:80" formatter="formartLocked">状态</th>
    </tr>
    </thead>
</table>
...
<div id="dlg-1" class="easyui-dialog" title="数据参数" style="z-Index: 100; width:600px;height: 450px"  modal="true" closed="true" buttons="#dlg-buttons-1">
    <form method="post">
        <table cellpadding="5">
            <tr>
                <td>如用户未更改密码，默认密码为admin</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>职务说明:</td>
                <td><input class="easyui-textbox" type="text" name="positonDesc" data-options="required:true"/></td>
            </tr>
            <tr>
                <td>状态:</td>
                <td>
                    ...
                    <table class="table-info-form">
                        <c:forEach var="sysmanRole" items="${sysmanRoleList}">
                            <tr>
                                ...
                                <td class="info-controller">
                                    <input id="${sysmanRole.pid }" value="${sysmanRole.pid }" type="checkbox" name="roles.pid" onclick="relRoleChange();"/>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
